...
import com.xycz.simple_live_tv.player.NativePlayerView;
...
public class FlutterActivity extends io.flutter.embedding.android.FlutterActivity implements Handler.Callback {
    ...
    public void configureFlutterEngine(@NonNull FlutterEngine flutterEngine) {
        ...
        flutterEngine.getPlatformViewsController().getRegistry().registerViewFactory("nativeVideoView", new PlatformViewFactory(null) {
            @NonNull
            @Override
            public PlatformView create(Context context, int viewId, @Nullable Object args) {
                return new NativePlayerView(context);
            }
        });
    }
